...
export function RsvpButton({
  ...
  const cls =
    variant === 'primary'
      ...
      : variant === 'ghost'
      ? 'min-h-12 rounded-full border border-ink px-5 py-3 text-body font-semibold text-ink hover:border-gold-deep hover:bg-gold-deep hover:text-paper transition-colors'
