...
// The hero uses the same shell as every section below it, so the headline
// starts where their headings start and the card still reaches the right
// edge. It used to be wider than the rest and pad its own left to fake the
// alignment; there is nothing left to compensate for.
...
export async function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="shell relative z-10 flex flex-col justify-center pt-8 pb-10 md:pt-10 md:pb-12"
        style={{
          minHeight: `min(calc(100svh - ${HEADER_H}px), ${980 - HEADER_H}px)`,
        }}
      >
